...
})({"gv22W":[function(require,module,exports,__globalThis) {
...
function reducer(state = initialState, action) {
    ...
    else if (action.type === INCREASE_BY) return {
        ...state,
        post: state.post + action.payload
    };
    else if (action.type === DECREASE_BY) return {
        ...state,
        post: state.post - action.payload
    };
    return state;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"3P2Jw"}],"3P2Jw":[function(require,module,exports,__globalThis) {
...
},{}]},["gv22W","6rimH"], "6rimH", "parcelRequire94c2")
